...
function act() {
    ...
    if (dirWall[i] == DERECHA)   wall[i].x += 10;
    if (dirWall[i] == IZQUIERDA) wall[i].x -= 10;
    if (dirWall[i] == ARRIBA)    wall[i].y -= 10;
    if (dirWall[i] == ABAJO)     wall[i].y += 10;

    if (wall[i].x >= canvas.width)  { wall[i].x = canvas.width - 10;  dirWall[i] = random(4); }
    if (wall[i].y >= canvas.height) { wall[i].y = canvas.height - 10; dirWall[i] = random(4); }
    if (wall[i].x < 0)             { wall[i].x = 0;                   dirWall[i] = random(4); }
    if (wall[i].y < 0)             { wall[i].y = 0;                   dirWall[i] = random(4); }
